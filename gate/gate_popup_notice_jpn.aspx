					...
					<td vAlign="middle" align="center" height="54">
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								...
								<td width="270" bgColor="#cdddd7"><b><asp:label id="lblSubject" runat="server"></asp:label></b></td>
								...
								<td bgcolor="#ffffff" width="286" align="center">
									<table cellSpacing="0" cellPadding="0" border="0">
										...
										<tr>
											...
											<td bgcolor="#ffffff" width="262" class="text"><asp:label id="lblText" runat="server"></asp:label></td>
											<td bgcolor="#ffffff" width="12"></td>
										</tr>
										<tr>
