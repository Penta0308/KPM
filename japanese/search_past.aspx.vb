...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If Not IsPostBack Then
            ...
            InitDropDownList(ddlMedia, "MediaNameJpn", "MediaID", "SELECT MediaID, MediaNameJpn FROM Media where MediaParentID=101 order by sequence", "すべて")
    ...
    Private Sub imgbtnSearch_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnSearch.Click
        ...
        If IsDate(SelectedDate) Then
            Dim DS As DataSet
            DS = WebNewsDB.GetArticlesByJunsongDateTime(CDate(SelectedDate), DateAdd(DateInterval.Day, 1, CDate(SelectedDate)), ddlMedia.SelectedValue, 201)
            InitDB(DS.Tables(0))
            DS.Dispose()
        Else
