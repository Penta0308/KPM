...
#End Region
    ...
    Private Sub binddata()
        Dim DS As DataSet
        DS = WebNewsDB.GetmmFilesByAuthID(Request.QueryString("EditMode"), CDate(txtGijunDateTime.Text), txtSearchWord.Text, 2)

        DataList1.DataSource = DS.Tables(0)
        DataList1.DataBind()


        DS = WebNewsDB.GetmmFilesByAuthID(Request.QueryString("EditMode"), CDate(txtGijunDateTime.Text), txtSearchWord.Text, 1)

        Datalist2.DataSource = DS.Tables(0)
        Datalist2.DataBind()


        DS = WebNewsDB.GetmmFilesByAuthID(Request.QueryString("EditMode"), CDate(txtGijunDateTime.Text), txtSearchWord.Text, 0)
    ...
    Private Function mmFileSave(ByVal IsJunSong As Boolean) As Boolean
        ...
        lblmmFileID.Text = WebNewsDB.SetmmFile(cmd, Val(lblmmFileID.Text), Request.QueryString("EditMode"), txtTitle.Text, txtTitleJpn.Text, txtTitleEng.Text, txtCaption.Text, txtCaptionJpn.Text, txtCaptionEng.Text, _
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        End If
        Response.Write("<script>window.location.href='MediaEditor.aspx?EditMode=" + Request.QueryString("EditMode") + "';</script>")
    End Sub
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If Not (lblmmFileID.Text = "" Or Val(lblmmFileID.Text) = 0) Then
            ...
            "&NavigateUrlYes=" + Server.HtmlEncode("MediaEditor.aspx?EditMode=" + Request.QueryString("EditMode")))
        End If
    End Sub
